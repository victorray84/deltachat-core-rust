...
mod tests {
    ...
    async fn test_get_draft() {
        ...
        chat_id.set_draft(&t.ctx, Some(&mut msg)).await.unwrap();
    ...
    async fn test_add_device_msg_unlabelled() {
        ...
        // check device chat
        assert_eq!(msg2.chat_id.get_msg_cnt(&t.ctx).await.unwrap(), 2);
    }
    ...
    async fn test_add_device_msg_labelled() {
        ...
        assert_eq!(chat_id.get_msg_cnt(&t.ctx).await.unwrap(), 1);
        assert!(!chat_id.is_special());
    ...
    async fn test_archive() {
        ...
        assert_eq!(get_chat_cnt(&t.ctx).await.unwrap(), 2);
    ...
    async fn test_set_protection() {
        ...
        let msgs = get_chat_msgs(&t.ctx, chat_id, 0, None).await.unwrap();
